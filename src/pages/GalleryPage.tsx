      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="soft-card p-8 sm:p-12 card-appear">
            <h1 className="text-left custom-heading relative inline-block">
              Our <span className="text-teal-500 relative z-10">Gallery</span>
              <span className="absolute left-0 bottom-1 w-full h-3 bg-teal-500/10 -rotate-1 z-0"></span>
            </h1>
            <p className="text-left max-w-2xl mt-4 text-base sm:text-lg text-gray-300 leading-relaxed">
      ...
      <div className="max-w-7xl mx-auto px-4 pb-12">
        {loading ? (
          ...
          <div className="space-y-16">
            {years.map((year) => (
              <div key={year}>
                <div className="flex items-center gap-4 mb-10 pt-12 border-b border-gray-800 pb-4">
                  <h2 className="text-3xl sm:text-4xl font-rashi font-bold text-gray-100">
                    {year}
                  </h2>
                ...
                <div
                  ...
                  {itemsByYear[year].map((item) => (
                    <div
                      ...
                      <div className="w-full aspect-[4/3] bg-[#0f172a]">
                        <ImageWithFallback
                      ...
                      <div className="p-4">
                        <h3 className="font-rashi font-semibold text-lg" style={{ color: "#e5e7eb" }}>
                          {item.title}
                        </h3>
