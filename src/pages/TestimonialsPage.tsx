  ...
  return (
    <div className="min-h-screen dark-theme content-offset">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h1 className="text-4xl text-center mb-4" style={{ color: '#e5e7eb', fontWeight: 700 }}>Customer Testimonials</h1>
        <p className="text-xl text-center mb-12" style={{ color: '#cbd5e1' }}>
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            <p style={{ color: '#cbd5e1' }}>No testimonials available yet</p>
          </div>
        )}
      </div>
