...
export function Footer() {
  ...
  const bg = isDarkTheme ? '#0f172a' : '#d1cfc8ff';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 items-start">
          <div className="flex flex-col md:items-start gap-4">
            ...
            <div className="flex gap-3">
              <a href="#" aria-label="Facebook" className="w-10 h-10 rounded-full border flex items-center justify-center" style={{ borderColor: accent, color: accent }}><Facebook className="w-5 h-5" /></a>
